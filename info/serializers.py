    ...
    def validate_patch(self, attrs) :
        ...
        try :
            ...
            try :
                if atr == 'no' and attrs['congenital_disease_description'] != '' :
                    raise ValueError("Congenital disease can't have description")
            except ValueError as e :
                raise serializers.ValidationError(e)
            except :
                raise serializers.ValidationError("Provide dependent field(s) of congenital_disease")
        ...
        try :
            ...
            try :
                if atr == 'no' and attrs['hereditary_disease_description'] != '' :
                    raise ValueError("Hereditary disease can't have description")
            except ValueError as e :
                raise serializers.ValidationError(e)
            except :
                raise serializers.ValidationError("Provide dependent field(s) of hereditary_disease_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of surgery")
        ...
        try :
            ...
            try :
                if atr == 'no' and attrs['alcohol_consumption_description'] != '' :
                    raise ValueError("Alcohol consumption disease can't have description")
            except ValueError as e :
                raise serializers.ValidationError(e)
            except :
                raise serializers.ValidationError("Provide dependent field(s) of alcohol_consumption_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of tobacco_consumption_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of medical_allergy_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of food_allergy_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of emotional_shock_background")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of single_child")
        ...
        try :
            ...
            try :
                ...
                raise serializers.ValidationError("Provide dependent field(s) of nearby_waves")
        ...
        try :
            ...
            try :
                if attrs['gender'] == 'male' :
                    if attrs['menopausal_condition'] != '' or attrs['irregular_menopausal'] != '' or attrs['birth_giving'] != '' :
                        raise ValueError("Only females fill these fields : menopausal_condition, irregular_menopausal and birth_giving")
                if attrs['gender'] == 'female' :
                    if attrs['menopausal_condition'] == '---------' or attrs['irregular_menopausal'] == '---------' or attrs['birth_giving'] == '---------' :
                        raise ValueError("Females must fill these fields : menopausal_condition, irregular_menopausal and birth_giving")
            except ValueError as e :
                raise serializers.ValidationError(e)
            except :
                raise serializers.ValidationError("Provide dependent field(s) of gender")
...
class UserSerializer(serializers.ModelSerializer) :
    ...
    def validate_password(self, value) :
        if len(value) < 5 :
            raise serializers.ValidationError('Password can not be less than 5 characters')
        return value

    def set_user_type(self, validated_data) :
        try :
            defined_user = DefinedPeople.objects.get(national_id=validated_data['username'])
        except :
            defined_user = None
